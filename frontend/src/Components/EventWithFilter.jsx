...
export const EventWithFilter = () => {
    ...
    return(
        <div className="w-full flex justify-center  space-x-5 p-8">
            ...
            <div className="flex flex-col w-4/5 space-y-5">
                <p className="text-4xl ml-12 font-bold text-[#000000]">Events in your city</p>
                <div className="grid space-y-5 grid-cols-3">
