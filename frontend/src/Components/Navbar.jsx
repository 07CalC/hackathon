...
export const Navbar = () => {
  return (
      ...
      <div className="h-12 z-[1]  border-b border-text w-full bg-lavendar flex justify-between items-center px-10">
          ...
          <div className="flex items-center space-x-2">
            ...
            <CiSearch className="text-text text-5xl cursor-pointer font-bold" />
            </div>
