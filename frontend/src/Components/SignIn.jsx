        ...
        <div className="flex p-2 justify-between">
            ...
            <div className="w-1/2 p-2 flex flex-col  space-y-8 justify-center items-center ">
                <div className="flex flex-col justify-center items-center w-full">
                    ...
                    <input className="bg-whitish border border-[#000000] my-4 w-7/12 rounded-full placeholder:text-[#1b3c72bc] placeholder:font-light p-2 text-center text-[1.2rem] shadow-sm shadow-[#000000]" placeholder="Email" />
                    
                    
                    <input className="bg-whitish w-7/12 border border-[#000000] rounded-full placeholder:text-[#1b3c72bc] p-2 placeholder:font-thin text-center text-[1.2rem] shadow-sm shadow-[#000000]" placeholder="Password" />
                    
                    <div className="w-7/12 px-8  mt-5 flex justify-center items-center">
                        <button className="w-3/6 hover:scale-105 mr-2 text-[#ffffff] text-2xl px-4 py-2 rounded-full bg-text">Sign In</button>
                       <button className="w-3/6 ml-2 hover:scale-105 text-text text-2xl px-4 py-2 rounded-full bg-whitish"> <NavLink to={"/signup"}>Sign Up</NavLink></button>
                    </div>
                </div>
